    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          {/* Email Update Form - Only show for email/password users */}
          {isEmailPasswordUser ? (
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 mt-1">
                      Your email address is managed by Google. To change your
                      email, please update it in your Google account settings.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Password Update Form - Only show for email/password users */}
          {isEmailPasswordUser ? (
            <div className="mt-8 pt-8 border-t border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">
                Update Password
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      ...
                      password, please update it in your Google account
                      settings.
                    </p>
                  </div>
                </div>
